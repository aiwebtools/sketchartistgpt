    ...
    <div className="flex items-center gap-2">
      ...
      <div className="flex flex-col text-left">
        ...
        <span className="text-xs text-white/60">
          Presented by <a href="https://www.aiwebtools.ai" target="_blank" rel="noopener noreferrer" className="text-cyber-purple hover:text-cyber-pink transition-colors">AiWebTools.Ai</a>
        </span>
      </div>
    </div>
  );
